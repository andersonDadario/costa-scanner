...
Currently 'changes' means that a new server is up. When this server is up, you can run Nmap and send the result directly to your e-mail or to any URL you want (webhook).
